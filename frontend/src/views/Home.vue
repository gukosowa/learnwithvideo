  ...
  <div class="bg-gray-900 text-white flex flex-grow" style="background-image: linear-gradient(-31deg, rgb(29, 33, 37) 0%, rgb(32, 41, 56) 100%);">
    ...
    <div class="container max-w-3xl">
      <div class="home flex flex-col">
        ...
        <div v-show="showHighlightText" class="highlightMenu rounded-lg bg-gray-900 py-3 px-2 z-50 absolute" style="transform: translate(-50%, -100%);" :style="{ left: `${xHighlightMenu}px`, top: `${yHighlightMenu}px` }" @mousedown.prevent="">
          <span class="mr-2 p-3 cursor-pointer" @mousedown.prevent="handleAction('share')">
            Add Word
          </span>
